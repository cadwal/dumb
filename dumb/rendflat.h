...
static inline void
_flatx_loop(fixed x, fixed y, fixed dx, fixed dy,
	    Pixel *out, Pixel *end,
...
static void
flatx_loop(fixed x, fixed y, fixed dx, fixed dy,
	   Pixel *out, Pixel *end,
...
static void
draw_flatx(Texture *tex, fixed height, int start_row, int end_row,
...
static void
draw_floor_slices(Active_wall *active,
...
static void
draw_ceiling_slices(Active_wall *active,
		    int sect, fixed start, fixed end)
{
