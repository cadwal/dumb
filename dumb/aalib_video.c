...
ConfItem video_conf[] =
{
   ...
   CONFS("font", NULL, 0, N_("name of the font you use"), NULL),
   CONFB_1("attr-normal", NULL, 0, N_("use the normal attribute")),
   CONFB_1("attr-bold", NULL, 0, N_("use the bold (double bright) attribute")),
